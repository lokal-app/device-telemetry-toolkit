...
public object DroidDex {
	...
	/**
	 * Updates the active raw performance data collection with a new delay interval
	 ...
	 * - Check if the library has been initialized
	 * - Preserves the original set of performance classes from startRawPerformanceDataCollection()
	 * - Cancel the current periodic job
	 * - Start a new periodic job with updated interval (fires immediately)
	...
	public fun updateRawPerformanceDataCollection(
		...
		return factory.updateRawPerformanceDataCollection(delaySeconds = delaySeconds)
	}
	...
	/**
	 * Updates the active detailed performance data collection with a new delay interval
	 * @param delaySeconds new interval in seconds between data collection cycles
	 * @return true if collection was updated, false if not initialized or no active collection
	 */
	public fun updateDetailedPerformanceDataCollection(
		...
		return factory.updateDetailedPerformanceDataCollection(delaySeconds = delaySeconds)
	}
